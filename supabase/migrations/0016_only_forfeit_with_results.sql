-- Het puntenverval bij vroeg wisselen (0015_soft_goal_switch_penalty.sql)
-- gold ook als een speler nog helemaal geen score op haar doel had
-- ingevuld — dan is er niks om te laten vervallen, dus hoeft de
-- waarschuwing/melding niet te verschijnen. Verval geldt nu alleen als er
-- minstens 1 resultaat op dit specifieke doel staat.
...
begin
  ...
  if v_current.exercise_id is not null and not is_trainer() then
    ...
    if v_aantal > 0 and v_aantal < 4 then
      v_vervallen := true;
