-- Je kunt geen score invoeren voor een training die nog niet heeft
-- plaatsgevonden. Geldt voor iedereen, ook de trainer — geen rol-
-- uitzondering nodig (anders dan het bewerk-venster uit 0003).
