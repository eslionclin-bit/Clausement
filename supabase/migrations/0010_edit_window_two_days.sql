-- Bewerk-venster voor spelers verruimd van "alleen dezelfde dag als de
-- oorspronkelijke invoer" naar "die dag of de dag erna" — anders kon een
-- training die gisteravond is ingevoerd vandaag al niet meer door een
-- speler aangevuld/gecorrigeerd worden. De trainer blijft ongelimiteerd.
